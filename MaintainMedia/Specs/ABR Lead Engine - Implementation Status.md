...
Paths above are within `abn-leadgen/src/abr_engine/` unless a configuration, test, migration or ops artifact is named. The file-level test map is [requirements.json](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/tests/requirements.json). Tests exercise actual PostgreSQL16; external transports are mocked and fixture sockets reject non-loopback destinations.

## Evidence to open

- [Run and recovery instructions](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/README.md) and [operator runbook](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/runbook.md).
- [Fixed scoring rubric](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/acceptance/rubric.md) and [score trajectory](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/acceptance/trajectory.md).
- [Independent handover](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/acceptance/handover-drill.md), [browser review](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/acceptance/browser-review.md) and [native restore receipt](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/acceptance/native-backup-drill.json).
- [Initial two-thread resource receipt](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/acceptance/diff-recheck-82f2b2206da3471dafed13746776852e.json):20.5M synthetic universe,20.295M rows per snapshot,1.435M output events in73.34s. The400k partition size was retained after200k/800k alternatives performed worse. Earlier OOM attempts remain recorded.
...
- [Database/WAL sample](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/acceptance/db-wal-sample-1000.json):1,000 real synthetic promoted records. WAL measurement is a concurrent cluster-wide upper bound, not exclusively attributable volume.
...
No full-spec PASS or production-ready claim is made. [G1â€“G7](C:/Users/dalig/Desktop/MaintainTech/MaintainOrg/maintain-media/abn-leadgen/ops/release-gates.md) remain pending: qualified source/collection/channel/retention policy, actual legacy rules or approved replacement, authentic source discovery/schema smoke, AU infrastructure and Linux scheduler/access drill, actual wash/vendor contracts and sandbox mappings, separately certified action consumers, and measured four/eight-week pilot outcomes. Live modes remain blocked while these required inputs are absent. Hosted CI configuration exists; a local run does not prove GitHub Actions has executed.
