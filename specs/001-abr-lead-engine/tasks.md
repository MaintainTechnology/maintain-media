...
- [ ] T071 Connect approved real ingestion, current licence/identity review, protected Next.js worklist, actual-editor bridge, CRM drain and suppression propagation end to end on the identified AU host; prove the full live workflow before changing demo labels per FR-001/FR-012/FR-025/FR-030/FR-031/FR-033/FR-037 (partial, HIGH; intake, accepted promotion, worklist/vendor adapters, release-005 runtime, private storage and staff connection setup are implemented; actual source/privacy/vendor acceptance, independent custody and restore, genuine staff/CRM/suppression workflows, accuracy and measured pilot evidence remain required).
